...
from dataload.test_util3 import test_all_case
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str,default='ASOCA_DWT', help='Name of Experiment')
    parser.add_argument('-snapshot_path',default='xnet3d-l=0.0001-e=600-s=6-g=0.99-b=2-w=20-20')
    parser.add_argument('-p', '--path_model', default='best_result1_Dc_0.8643.pth')
    ...
    snapshot_path="/home/ac/datb/wch/checkpoints/semi/"+args.root_path+"/"+args.snapshot_path+"/fold"+str(args.fold)+"/"
    ...
    state_dict = torch.load(path_model)# 加载预训练权重参数
