# nohup python ASOCA_train_sup_DSCNet.py >ASOCA_DSCNet_fold02.out &
...
from config.train_test_config.train_test_config import print_train_loss_sup, print_val_loss_sup, print_train_eval_sup, print_val_eval_sup, save_val_best_sup_3d
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fold', type=int,default=1, help='cross validation')#第几折 比如分为4折交叉fold就被设置为0-3
    ...
    parser.add_argument('-n', '--network', default='DSCNet', type=str)
    ...
    for epoch in range(args.num_epochs):
        ...
        for i,sampled_batch_labeled in enumerate(dataloaders['train']):
            ...
            with torch.amp.autocast('cuda',enabled=True):
                ...
                loss_train=ce_loss(outputs_train,mask_train[:])
        ...
        if count_iter % args.display_iter == 0:
            ...
            with torch.no_grad():
                ...
                for i, sampled_batch_labeled in enumerate(dataloaders['val']):
                    ...
                    loss_val=ce_loss(outputs_val,mask_val)
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('ASOCA_DSCNet_fold01.png')
