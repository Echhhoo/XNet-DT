...
# 读取数据并提取jc和dc值
with open('/home/ac/datb/wch/checkpoints/sup/ZDCTA_DWT/xnetv2_3d_min-l=0.0001-e=200-s=2-g=0.99-b=2-w=20-100/sup_xnetv2_dwt_dice_fold03.out', 'r') as file:
...
for i in range(0,len(dc_values_1)):
    dc_values = [dc_values_1[i], dc_values_2[i],dc_values_3[i]]
