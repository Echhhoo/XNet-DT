...
from dataload.test_util4 import test_all_case
...
if __name__ == '__main__':
    ...
    parser.add_argument('-snapshot_path',default='xnetv2_3d_min-l=0.0001-e=600-s=6-g=0.99-b=2-w=20-100')
    parser.add_argument('-p', '--path_model', default='best_result1_Dc_0.8993.pth')
    ...
    parser.add_argument('-n', '--network', default='xnetv2_3d_min')
