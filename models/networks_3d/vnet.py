...
class VNet(nn.Module):
    ...
    def __init__(self, in_channels=1, classes=1, elu=True):
        ...
        self.down_tr32 = DownTransition(self.filters[0], 1, elu)
        self.down_tr64 = DownTransition(self.filters[1], 2, elu)
        self.down_tr128 = DownTransition(self.filters[2], 3, elu, dropout=False)
        self.down_tr256 = DownTransition(self.filters[3], 2, elu, dropout=False)
        self.up_tr256 = UpTransition(self.filters[4], self.filters[4], 2, elu, dropout=False)
        self.up_tr128 = UpTransition(self.filters[4], self.filters[3], 2, elu, dropout=False)
        self.up_tr64 = UpTransition(self.filters[3], self.filters[2], 1, elu)
        self.up_tr32 = UpTransition(self.filters[2], self.filters[1],1, elu)
        self.out_tr = OutputTransition(self.filters[1], classes, elu)
