...
class XNetv2_3D_min(nn.Module):
    ...
    def forward(self, x_main, x_H, x_L):
        # Main encoder
        M_enc1 = self.M_encoder1(x_main)
        M_enc2 = self.M_encoder2(self.M_pool1(M_enc1))
        M_enc3 = self.M_encoder3(self.M_pool2(M_enc2))
...
#     print(output1.shape)
# if __name__ == '__main__':
#     model = xnetv2_3d_min(1,2)
#     model.eval()
#     input1 = torch.rand(2, 1, 128, 128, 128)
#     input2 = torch.rand(2, 1, 128, 128, 128)
#     input3 = torch.rand(2, 1, 128, 128, 128)
#     macs, params = profile(model, inputs=(input1,input2,input3))
...
if __name__ == '__main__':
    ...
    model = xnetv2_3d_min(in_channels=1, num_classes=2)
    summary(model, [(2, 1, 128, 128, 128), (2, 1, 128, 128, 128), (2, 1, 128, 128, 128)], device='cpu')
    print(model)
    input = torch.randn(2, 1, 128, 128, 128).cuda()
    macs, params = profile(model.cuda(), (input,input,input,))
