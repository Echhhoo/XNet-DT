# nohup python ASOCA_train_sup_resunet3d.py >sup_resunet_fold00.out &
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--network', default='resunet3d', type=str)
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('sup_resunet_fold02.png')
